...
const std::array<TestType, 6> kTestParam = {std::make_tuple(3, "3x3"),    std::make_tuple(5, "5x5"),
                                            std::make_tuple(7, "7x7"),    std::make_tuple(1, "1x1"),
                                            std::make_tuple(10, "10x10"), std::make_tuple(100, "100x100")};
